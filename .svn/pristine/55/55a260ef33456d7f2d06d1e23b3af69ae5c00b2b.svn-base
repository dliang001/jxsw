...
<head>
    ...
    <script src="<?php echo (BOKE_STATIC_PATH); ?>/manager/js/pintuer.js"></script>  
</head>
<body>
<div class="bg"></div>
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="<?php echo U('Public/dologin');?>" method="post" onsubmit="return login_check()">
	...
	<script type="text/javascript">
		function login_check()
		{
			...
			if (user == '') {
				layer.msg('请输入登录账号'); return false;
			}
			if (pwd == '') {
