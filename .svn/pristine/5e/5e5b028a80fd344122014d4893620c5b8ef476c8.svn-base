    ...
    b.prototype = {
        ...
        backdrop: function(b) {
            ...
            if (this.isShown && this.options.backdrop) {
                if (e = a.support.transition && d, this.$backdrop = a('<div class="modal-backdrop ' + d + '" />').appendTo(document.body), this.$backdrop.click("static" == this.options.backdrop ? a.proxy(this.$element[0].focus, this.$element[0]) : a.proxy(this.hide, this)), e && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), !b) {
                    return
                }
    ...
    c.prototype = {
        ...
        keydown: function(c) {
            ...
            if (/(38|40|27)/.test(c.keyCode) && (d = a(this), c.preventDefault(), c.stopPropagation(), !d.is(".disabled, :disabled"))) {
                if (h = e(d), i = h.hasClass("open"), !i || i && 27 == c.keyCode) {
                    return 27 == c.which && h.find(b).focus(), d.click()
                }
...
(function(e) {
    Date.now = Date.now || function() {
        ...
        function p(t, r) {
            ...
            if (!s) {
                return n.noneleft && e(n.container).find(n.item).last().after(n.noneleft), l()
            }
...
+(function($) {
    $(document).ready(function() {
        ...
        $("body").append('<div class="rollto"><button class="btn btn-inverse" data-type="totop" title="回顶部"><i class="fa fa-arrow-up"></i></button>' + (_deel.commenton ? '<button class="btn btn-inverse" data-type="torespond" title="发评论"><i class="fa fa-comment-o"></i></button>' : "") + "</div>");
        (function($) {
            $.extend({
