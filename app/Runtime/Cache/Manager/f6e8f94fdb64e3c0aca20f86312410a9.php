...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <ul class="search" style="padding-left:10px;">
            <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Company/add',array('cid'=>21));?>"> 添加内容</a> </li>
            <form class="form-inline" role="form" action="<?php echo u('Company/notice');?>" method="get">
...
<td colspan="10">
    ...
    function editistop(article_id, status) {
        //alert(article_id);alert(status);
        $.ajax({
            url: '/boke/manager.php/Company/notice_editistop',
            data: { "status": status, "article_id": article_id },
            dataType: "json",
            type: 'post',
            success: function(msg) {
