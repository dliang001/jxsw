...
<body>
    <div class="panel admin-panel">
        ...
        <div class="body-content">
            <form method="post" class="form-x" action="<?php echo U('Company/addarticle');?>" onsubmit="return addarticle()" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <?php if($id != '' ): ?><input type="text" class="input w50" name="author"  value="<?php echo ($data['author']); ?>" />
                            <?php else: ?>
