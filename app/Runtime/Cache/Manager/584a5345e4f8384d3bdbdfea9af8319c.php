...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <ul class="search" style="padding-left:10px;">
            <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Company/add',array('cid'=>20));?>"> 添加内容</a> </li>
            <form class="form-inline" role="form" action="<?php echo u('Company/lingdao');?>" method="get">
