...
<body>
    <div class="panel admin-panel">
        <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>工程动态</strong></div>
        <div class="body-content">
            <form method="post" class="form-x" action="<?php echo U('Admin/addarticle');?>" onsubmit="return addarticle()" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <?php if($id != '' ): ?><input type="text" class="input w50" name="author" readonly unselectable="on" value="<?php echo ($data['author']); ?>" />
                            <?php else: ?>
                            <input type="text" class="input w50" name="author"  value="" /><?php endif; ?>
                        <div class="tips"></div>
                    </div>
                </div>
               <!--  <div class="form-group">
