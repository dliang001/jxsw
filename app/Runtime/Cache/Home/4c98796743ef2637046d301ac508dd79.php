        ...
        <section>
            <div class="content_310 ">
                <div class="about_bg ">
                    ...
                    <ul class="about_list ">
                        <li><a href="<?php echo U( 'company/news',array( 'id'=>19));?>"><span><img src="/boke/Public/img/about_point.png "></span>公司新闻</a></li>
                        <li><a href="<?php echo U( 'company/news',array( 'id'=>20));?>"><span><img src="/boke/Public/img/about_point.png "></span>领导关怀</a></li>
                        <li><a href="<?php echo U( 'company/news',array( 'id'=>21));?>"><span><img src="/boke/Public/img/about_point.png "></span>公司公示</a></li>
            ...
            <div class="content_924 ">
                <div class="ys_line ">
                    <p>当前位置：<a href="<?php echo U( 'index/index');?> ">首页</a>><a href="<?php echo U( 'company/news');?> ">公司动态</a>><a href="news.html ">
                     <?php switch($id): case "19": ?>公司新闻<?php break;?>
                                    <?php case "20": ?>领导关怀<?php break;?>
                                   <?php case "21": ?>公告公示<?php break; endswitch;?>
                </a></p>
                </div>
                <section class="ys_page ">
                   <ul class="ys_page_list ">
                        <?php if(is_array($list )): $i = 0; $__LIST__ = $list ;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                <a href="<?php echo U('company/newspage',array('a_id'=>$vo['a_id']));?> "><?php echo ($vo['title']); ?><span><?php echo ($vo['createtime']); ?></span>
                                </a>
