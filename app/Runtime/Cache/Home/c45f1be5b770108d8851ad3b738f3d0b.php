...
<body onload="getTime()">
    ...
    <div class="ys_head"><img src="img/head.jpg">
        <div class="search">
                ...
                <div class="tm-navbar-bg">
                    ...
                    <div class="collapse navbar-toggleable-md text-xs-center text-uppercase tm-navbar" id="tmNavbar">
                        <ul class="nav navbar-nav">
                            <li class="nav-item ">
                                <a class="nav-link" href="index.html" data-no="1">网站首页 <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="about.html" data-no="2">公司概况</a>
                            </li>
                            <li class="nav-item active selected">
                                <a class="nav-link" href="news.html" data-no="3">公司动态</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="partyBuilding.html" data-no="4">党建动态</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="engineering.html" data-no="5">工程动态</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="personnel.html" data-no="6">人事信息</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="contactus.html" data-no="6">联系我们</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- .cd-hero -->
    <div class="ys_banner"><img src="img/slide1.jpg"></div>
    <section class="warp1250">
        <div class="ys_time">
            <div id="dateTime" style="margin-left: 34px"></div>
        </div>
        <section>
            <div class="content_310">
            	<div class="about_bg">
            		<p>公司动态/<span>News</span></p>
            		<ul class="about_list">
            			<li><a href="news.html"><span><img src="img/about_point.png"></span>公司新闻</a></li>
            			<li><a href="leadership.html"><span><img src="img/about_point.png"></span>领导关怀</a></li>
            			<li><a href="publicity.html"><span><img src="img/about_point.png"></span>公司公示</a></li>
            ...
            <div class="content_924">
                <div class="ys_line">
                    <p>当前位置：<a href="">首页</a>><a href="news.html">公司动态</a>><a href="leadership.html">领导关怀</a></p>
                </div>
                <section class="ys_page">
                   <ul class="ys_page_list">
                       <li><a href="">领导关怀<span>2017-11-13</span></a></li>
                       <li><a href="">领导关怀<span>2017-11-13</span></a></li>
                       <li><a href="">领导关怀<span>2017-11-13</span></a></li>
                       <li><a href="">领导关怀<span>2017-11-13</span></a></li>
                       <li><a href="">领导关怀<span>2017-11-13</span></a></li>
        ...
        <section class="content_2">
            <ul class="friendly">
                ...
                <li><img src="img/002-1.jpg"></li>
                <li><img src="img/002-2.jpg"></li>
