    ...
    <section class="warp1250 ">
        ...
        <section>
            <div class="content_310 ">
                <div class="about_bg ">
                    <p>公司概况/<span>About</span></p>
                    <ul class="about_list ">
                        <li><a href="<?php echo U( 'index/about',array( 'id'=>22));?>"><span><img src="/boke/Public/img/about_point.png"></span>公司简介</a>
                            </li>
                            <li><a href="<?php echo U('index/about',array('id'=>23));?>"><span><img src="/boke/Public/img/about_point.png"></span>组织机构</a></li>
                            <li><a href="<?php echo U('index/about',array('id'=>24));?>"><span><img src="/boke/Public/img/about_point.png"></span>领导信息</a></li>
                            <li><a href="<?php echo U('index/about',array('id'=>25));?>"><span><img src="/boke/Public/img/about_point.png"></span>联系我们</a></li>
                        </ul>
                    </div>
                </div>
                <div class="content_924">
                    <div class="ys_line">
                        <p>当前位置：<a href="<?php echo U('index/index');?>">首页</a>>
                           <a href=" <?php echo U('index/about',array('id'=>$id));?>">
                                <?php switch($id): case "22": ?>公司简介<?php break;?>
                                    <?php case "23": ?>组织机构<?php break;?>
                                   <?php case "24": ?>领导信息<?php break;?>
                                    <?php case "25": ?>联系我们<?php break; endswitch;?>
                                </a>
                        </p>
                    </div>
